...
- **Barra de actividad** (extremo izquierdo, ~56px, nunca se esconde): íconos para cambiar de pantalla (Parámetros de entrada / Planta y Perfil / Catálogo / Cálculo mecánico / Resumen), más el engranaje de Configuración y el toggle de tema al fondo.
